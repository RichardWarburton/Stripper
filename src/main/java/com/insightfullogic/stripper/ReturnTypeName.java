...
public class ReturnTypeName implements MethodPredicate {

	@VisibleForTesting
	final String typeName;

	public ReturnTypeName(final String typeName) {
		this.typeName = typeName;
	}

	@Override
	public boolean apply(final MethodNode input) {
		final Type argumentType = Type.getReturnType(input.desc);
